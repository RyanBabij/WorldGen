...
The program is designed to be reasonably fast, and on my rig it generates a 1025x1025 map in about 3 seconds. In my games, 1 pixel is meant to represent 25 square kilometers. Therefore this program generates an area of 26,265,625 square kilometers in roughly 3 seconds. This is enough area to cover Western Europe, North Africa, and Eastern Europe up to the Caspian Sea, which I think is a reasonable amount of space for most grand-strategy games. The size of the worlds generated can be increased to generate landmasses several times larger than Earth, but it can take a few minutes, and can generate gigabytes of data.
